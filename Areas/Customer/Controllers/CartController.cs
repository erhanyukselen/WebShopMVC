...
namespace WebShopMVC.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary(ShoppingCartVM model)
        {
            ...
            ShoppingCartVM.OrderHeader.OrderStatus = Other.Durum_Beklemede;
            ...
            //Siparişten sonra sepeti sıfırlamak için
        ...
        private Payment PaymentProcess(ShoppingCartVM model)
        {
            ...
            options.ApiKey = "sandbox-8Rf8SWMnT8f9Wj8VOfr4IaUq2BnaZOFO";
            options.SecretKey = "sandbox-MnWR9Rjusz6oKOzGyHrILieDQBmwDYsr";
        ...
        public async Task<IActionResult> IndexPost()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Confirm Email Empty");
            }
            ...
            ModelState.AddModelError(string.Empty, "Send Confirm Emai Code");
